...
public class App
{
    public static void main(String[] args ) throws Exception {
        ...
        try {
            ...
            // Execute request
            final HttpGet request1 = new HttpGet("https://bloomberg.com/markets/api/security/currency/cross-rates/AUD,CNY,EUR,GBP,HKD,IDR,JPY,KRW,MYR,PHP,SGD,THB,USD,VND,AED,CAD,INR,MVR,TRY,TWD");
